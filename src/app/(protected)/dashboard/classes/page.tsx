...
export default function Courses() {
  ...
  return (
    <div className="space-y-8">
      ...
      <h2 className="font-bold text-yellow-950 text-4xl pt-9">
        Posts List
      </h2>
...
// import { useGetPostsQuery, useGetProfileQuery } from "@/features/api/apiSlice";
...
//   return (
//     <div>
//       {/* <h2 className="font-bold text-amber-600 text-4xl pb-8"> */}
//       <h2 className="font-bold text-yellow-950 text-4xl">Users List</h2>

//           {profileData?.map((user) => (
//         <p className="font-bold text-amber-600" key={user.id}>{user.name}</p>
//       ))}
//       {/* </h2> */}
