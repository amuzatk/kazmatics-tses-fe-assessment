...
import { CircleOutlineIcon, CircleTickIcon, ModuleCompletedIcon } from "@/svg";
...
export default function LessonSidebar({
        ...
        {modules.map((module) => {
          ...
          return (
            <div key={module.key}>
              ...
              >
                <span className="font-bold text-[#202020] text-[14px] md:text-[16px] ">
                  {module.title}
                </span>
  ...
  `}
              ...
              {/* QUIZ LABEL */}
              {isOpen && module.isQuiz && (
                <div className="mt-3 text-[14px] text-gray-600 px-4 py-3">
                  Final Assessment
                </div>
              )}
            </div>
