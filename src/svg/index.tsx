...
export const DashboardIcon = ({ stroke = "#636363", width = DEFAULT_SIZE, height = DEFAULT_SIZE, className }: NavIconProps) => (
  <svg 
    className={className}
    width={width} 
    height={height} 
...
export const CoursesIcon = ({ stroke = "#636363", width = DEFAULT_SIZE, height = DEFAULT_SIZE, className }: NavIconProps) => (
  <svg 
    className={className}
    width={width} 
    height={height} 
...
export const ClassesIcon = ({ stroke = "#636363", width = DEFAULT_SIZE, height = DEFAULT_SIZE, className }: NavIconProps) => (
  <svg 
    className={className}
    width={width} 
    height={height} 
...
export const AssessmentsIcon = ({ stroke = "#636363", width = DEFAULT_SIZE, height = DEFAULT_SIZE, className }: NavIconProps) => (
  <svg 
    className={className}
    width={width} 
    height={height} 
...
export const CertificationIcon = ({ stroke = "#636363", width = DEFAULT_SIZE, height = DEFAULT_SIZE, className }: NavIconProps) => (
  <svg 
    className={className}
    width={width} 
    height={height} 
...
export const SettingsIcon = ({ stroke = "#636363", width = DEFAULT_SIZE, height = DEFAULT_SIZE, className }: NavIconProps) => (
  <svg 
    className={className}
    width={width} 
    height={height} 
